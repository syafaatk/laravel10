    ...
    <form method="post" action="{{ route('profile.update') }}" class="space-y-8" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-md p-6 border border-blue-200">
                ...
                <div class="mb-4">
                    @if ($user->attachment_foto_profile)
                        <img src="{{ asset('storage/' . $user->attachment_foto_profile) }}" alt="Profile" class="w-full h-48 object-cover rounded-lg border-2 border-white shadow-md">
                    @else
            ...
            <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg shadow-md p-6 border border-indigo-200">
                ...
                <div class="mb-4">
                    @if ($user->attachment_ttd)
                        <img src="{{ asset('storage/' . $user->attachment_ttd) }}" alt="Signature" class="w-full h-48 object-cover rounded-lg border-2 border-white shadow-md">
                    @else
                        <div class="w-full h-48 bg-white rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
                            <div class="text-center">
                                <svg class="w-12 h-12 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
            ...
            <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg shadow-md p-6 border border-green-200">
                ...
                @endphp
                <div class="p-4 mt-4 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-lg">
                    <p class="text-sm font-semibold text-gray-700 uppercase">{{ __('Total Salary & Allowance') }}</p>
                    <p class="text-3xl font-bold text-orange-600 mt-2">Rp {{ number_format($total, 0, ',', '.') }}</p>
                </div>
            </div>

            {{-- POSITION & CONTRACT --}}
            <div class="bg-gradient-to-br from-yellow-50 to-emerald-50 rounded-lg shadow-md p-6 border border-green-200">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-6 pt-4 border-b border-gray-200 flex items-center gap-2">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <x-text-input id="gaji_pokok" name="gaji_pokok" type="number" class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" :value="old('gaji_pokok', $user->gaji_pokok)" placeholder="5000000" autocomplete="off" />
                ...
                <div>
                    ...
                    <x-text-input id="gaji_tunjangan_tetap" name="gaji_tunjangan_tetap" type="number" class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" :value="old('gaji_tunjangan_tetap', $user->gaji_tunjangan_tetap)" placeholder="500000" autocomplete="off" />
                ...
                <div>
                    ...
                    <x-text-input id="gaji_tunjangan_transport" name="gaji_tunjangan_transport" type="number" class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" :value="old('gaji_tunjangan_transport', $user->gaji_tunjangan_transport)" placeholder="1000000" autocomplete="off" />
                ...
                <div>
                    ...
                    <x-text-input id="gaji_tunjangan_lain" name="gaji_tunjangan_lain" type="number" class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" :value="old('gaji_tunjangan_lain', $user->gaji_tunjangan_lain)" placeholder="300000" autocomplete="off" />
                ...
                <div>
                    ...
                    <x-text-input id="gaji_bpjs" name="gaji_bpjs" type="number" class="mt-2 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" :value="old('gaji_bpjs', $user->gaji_bpjs)" placeholder="100000" autocomplete="off" />
