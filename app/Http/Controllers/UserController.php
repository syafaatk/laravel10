...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        $request->validate([
            ...
            'tunjangan_golongan' => 'nullable|integer|min:0',
            'gaji_tunjangan_makan' => 'nullable|integer|min:0',
            'tunjangan_rumah' => 'nullable|integer|min:0',
            'gaji_tunjangan_transport' => 'nullable|integer|min:0',
            'tunjangan_tambahan' => 'nullable|integer|min:0',
            'tunjangan_extra' => 'nullable|integer|min:0',
            'gaji_bpjs' => 'nullable|integer|min:0',
            'premi_jkk_jkm' => 'nullable|integer|min:0',
            'potongan_pph21' => 'nullable|integer|min:0',
            'potongan_jmo' => 'nullable|integer|min:0',
        ]);
